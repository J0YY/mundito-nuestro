...
Aunque se supone que la haremos juntos, la estoy tejiendo yo sola —Joy— para regalárnosla en nuestro aniversario. Quiero que cuando la abramos veamos los planes, los tropiezos y las promesas que todavía están en borrador, listos para crecer.

Este rincón digital nos recordará que siempre tendremos un lugar al que volver para ver la historia en orden, con nuestros colores y latitudes. No pretende explicar cómo se construye nada: solo deja constancia de que existirá un mapa pequeño donde el norte seremos nosotros.
